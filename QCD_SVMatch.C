...
void Alakazam(){
  ...
  fbkg = "QCD_Pt-470to600_Tune4C_13TeV_pythia8_R08_r015_HiggsWin20_mc_subjets"+deltaHiggsMass+"_FULL_mc_subjets";
  //fbkg = "QCD_Pt-470to600_Tune4C_13TeV_pythia8_R08_r015_HiggsWin20_fakerate01_MjSVdR015_BTagAllMj_mc_subjets";

  var = "Mj_dR_SV";
  //xbin = 45; xmin = 0; xmax = 0.15; xlabel = "Microjet-IVF SV #Delta R matching";
  xbin = 45; xmin = 0; xmax = 0.15; xlabel = "Microjet-AVF SV #Delta R matching";
