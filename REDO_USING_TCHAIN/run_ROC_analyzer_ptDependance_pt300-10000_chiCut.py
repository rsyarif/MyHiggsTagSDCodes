import os, sys
from ROOT import *
from ROC_analyzer_v2 import runAnalysis
...
chiCut = -15 #logchi = -15.0, eff_s =  0.707508803215 , rej_b =  0.826876523574

print "PROCESSING FOR PT DEPENDANCE ANALYSIS"
print " "
# print "Processing signal - Rad"
# cIn  = TChain("btaganaSubJets/ttree")
# fOut = TFile ("ROC_analyzer_Rad_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
# w = 1.
...
# fOut = TFile ("ROC_analyzer_QCD300_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
# w = 7475./1986177.
# print "Chaining files ..."
...
# fOut = TFile ("ROC_analyzer_QCD470_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
# w = 587.1/2001071.
# print "Chaining files ..."
...
# fOut = TFile ("ROC_analyzer_QCD600_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
# w = 167.0/2001071.
...
# fOut = TFile ("ROC_analyzer_QCD800_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
# w = 28.25/1000065.
# print "Chaining files ..."
...
fOut = TFile ("ROC_analyzer_QCD1000_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
w = 8.195/500550.
print "Chaining files ..."
...
fOut = TFile ("ROC_analyzer_QCD1400_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
w = 0.7346/199627.0
...
fOut = TFile ("ROC_analyzer_QCD1800_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
w = 0.102/200079.
print "Chaining files ..."
...
fOut = TFile ("ROC_analyzer_QCD2400_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
w = 0.00644/200453.
print "Chaining files ..."
...
fOut = TFile ("ROC_analyzer_QCD3200_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
w = 0.000163/200200.
print "Chaining files ..."
...
fOut = TFile ("ROC_analyzer_Zpr_ptDependanceCalc_pt300-10000_chiCut.root", "recreate")
w = 1.0
print "Chaining files ..."
