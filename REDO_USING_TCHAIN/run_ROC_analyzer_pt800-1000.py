...
# fOut = TFile ("ROC_analyzer_Rad_pt800-1000.root", "recreate")
# w = 1.
...
# fOut = TFile ("ROC_analyzer_QCD300_pt800-1000.root", "recreate")
# w = 7475./1986177.
# print "Chaining files ..."
...
# fOut = TFile ("ROC_analyzer_QCD470_pt800-1000.root", "recreate")
# w = 587.1/2001071.
# print "Chaining files ..."
...
# fOut = TFile ("ROC_analyzer_QCD600_pt800-1000.root", "recreate")
# w = 167.0/2001071.
...
# fOut = TFile ("ROC_analyzer_QCD800_pt800-1000.root", "recreate")
# w = 28.25/1000065.
# print "Chaining files ..."
...
# fOut = TFile ("ROC_analyzer_QCD1000_pt800-1000.root", "recreate")
# w = 8.195/500550.
# print "Chaining files ..."
...
# fOut = TFile ("ROC_analyzer_QCD1400_pt800-1000.root", "recreate")
# w = 0.7346/199627.0
...
# fOut = TFile ("ROC_analyzer_QCD1800_pt800-1000.root", "recreate")
# w = 0.102/200079.
# print "Chaining files ..."
...
# fOut = TFile ("ROC_analyzer_QCD2400_pt800-1000.root", "recreate")
# w = 0.00644/200453.
# print "Chaining files ..."
...
# fOut = TFile ("ROC_analyzer_QCD3200_pt800-1000.root", "recreate")
# w = 0.000163/200200.
# print "Chaining files ..."
...
fOut = TFile ("ROC_analyzer_Zpr_pt800-1000.root", "recreate")
w = 1.0
print "Chaining files ..."
