...
fOut = TFile ("ROC_analyzer_Rad.root", "recreate")
w = 1.
...
runAnalysis(cIn, w, fOut, massCut, ptCut)

print "Processing QCD300"
ch1  = TChain("btaganaSubJets/ttree")
fOut = TFile ("ROC_analyzer_QCD300.root", "recreate")
w = 7475./1986177.
print "Chaining files ..."
...
runAnalysis(ch1, w, fOut, massCut, ptCut)

print "Processing QCD470"
ch2  = TChain("btaganaSubJets/ttree")
fOut = TFile ("ROC_analyzer_QCD470.root", "recreate")
w = 587.1/2001071.
print "Chaining files ..."
...
runAnalysis(ch2, w, fOut, massCut, ptCut)

print "Processing QCD600"
ch3  = TChain("btaganaSubJets/ttree")
fOut = TFile ("ROC_analyzer_QCD600.root", "recreate")
w = 167.0/2001071.
...
runAnalysis(ch3, w, fOut, massCut, ptCut)

print "Processing QCD800"
ch4  = TChain("btaganaSubJets/ttree")
fOut = TFile ("ROC_analyzer_QCD800.root", "recreate")
w = 28.25/1000065.
print "Chaining files ..."
...
runAnalysis(ch4, w, fOut, massCut, ptCut)

print "Processing QCD1000"
ch5  = TChain("btaganaSubJets/ttree")
fOut = TFile ("ROC_analyzer_QCD1000.root", "recreate")
w = 8.195/500550.
print "Chaining files ..."
...
runAnalysis(ch5, w, fOut, massCut, ptCut)

print "Processing QCD1400"
ch6  = TChain("btaganaSubJets/ttree")
fOut = TFile ("ROC_analyzer_QCD1400.root", "recreate")
w = 0.7346/199627.0
...
runAnalysis(ch6, w, fOut, massCut, ptCut)

print "Processing QCD1800"
ch7  = TChain("btaganaSubJets/ttree")
fOut = TFile ("ROC_analyzer_QCD1800.root", "recreate")
w = 0.102/200079.
print "Chaining files ..."
...
runAnalysis(ch7, w, fOut, massCut, ptCut)

print "Processing QCD2400"
ch8  = TChain("btaganaSubJets/ttree")
fOut = TFile ("ROC_analyzer_QCD2400.root", "recreate")
w = 0.00644/200453.
print "Chaining files ..."
...
runAnalysis(ch8, w, fOut, massCut, ptCut)

print "Processing QCD3200"
ch9  = TChain("btaganaSubJets/ttree")
fOut = TFile ("ROC_analyzer_QCD3200.root", "recreate")
w = 0.000163/200200.
print "Chaining files ..."
...
runAnalysis(ch9, w, fOut, massCut, ptCut)

print "Processing Zpr"
ch3  = TChain("btaganaSubJets/ttree")
fOut = TFile ("ROC_analyzer_Zpr.root", "recreate")
w = 1.0
print "Chaining files ..."
ch3.Add("/eos/uscms/store/user/rsyarif/SDstudies/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT020_Hwin30_tag07_fake02/150703_215948/0000/*.root")
runAnalysis(ch3, w, fOut, massCut, ptCut)
# 
# makeROC("tau21",0.,1.,0)
# makeROC("logchi",-26.,-6.,1)
# makeROC("pt",150,1600,1)
# makeROC("qvol",0,0.5,0)
# 
# files=[]
# 
