...
void makeHistos_3bkg_compareSubstructure_300470(){
  ...
  postfix = "RadM800_KtHW30tag07fake02_3bkg_pt300470";labels.push_back("#DeltaM_{H}=30, tag 70% fake 20%");
...
void makeHistos_3bkg_compareSubstructure_470600(){
  ...
  postfix = "RadM800_KtHW30tag07fake02_3bkg_pt470600";labels.push_back("#DeltaM_{H}=30, tag 70% fake 20%");
...
void makeHistos_3bkg_compareSubstructure_opt_300470(){
  ...
  postfix = "RadM800_Kt020HW30tag07fake02_3bkg_pt300470";labels.push_back("#DeltaM_{H}=30 tag=70% fake=20% r=0.2");
...
void makeHistos_3bkg_compareSubstructure_opt_470600(){
  ...
  postfix = "RadM800_Kt020HW30tag07fake02_3bkg_pt470600";labels.push_back("#DeltaM_{H}=30 tag=70% fake=20% r=0.2");
...
// void makeHistos_3bkg_optimization_temp_300470(){
//   vector<TString> chains; cout<< "Chaining files ..."<<endl;
//   vector<string> postfix;
//   vector<string> labels;
//   TString info;
