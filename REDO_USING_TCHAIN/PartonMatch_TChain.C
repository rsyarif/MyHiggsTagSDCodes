...
int PartonMatch(std::string fdir, std::string fname, int gen_pdgid,double dRmax = 1.2, double MjCone = 0.15, bool display=false, std::string postfix = ""){
  ...
  TChain *tf = new TChain("btaganaSubJets/ttree");

  tf->Add((fdir+"/"+fname+"/*.root").c_str());

  const int nEvent = tf->GetEntries();
  int nMatchMax = 0;
  vector<int> iEventOverMatch;

  const int nGenPrunedMax = 500;
  ...
  int nMj_gen = 300; //4 b's
  const int nMjGenMax = 300;
  ...
  cout<<endl;
  cout<<"Creating new root file containing Fatjet based tree: "<< "fMatch_"+fname.substr(0,10)+"_"+postfix+".root" << endl;
  TFile *fMatch = new TFile(("fMatch_"+fname.substr(0,10)+"_"+postfix+".root").c_str(),"RECREATE"); //DIFFERENCE BETWEEN USING POINTER???
...
void PartonMatch(bool display = false){
  ...
  postfix = "HW10_";
  fsig = "Rad_HHto4b_M800_13TeV/Rad_M800_kT015_Hwin10_tag07_fake001/150708_195601/0000";
  fbkg = "ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT015_Hwin10_tag07_fake001/150708_195638/0000";
  ...
  fbkg = "ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT015_Hwin20_tag07_fake001/150708_195801/0000";
  sig_l = PartonMatch(dir,fsig,25,dRmax,MjCone,display,postfix);
  bkg_l = PartonMatch(dir,fbkg,6,dRmax,MjCone,display,postfix);

  postfix = "HW30_";
  fsig = "Rad_HHto4b_M800_13TeV/Rad_M800_kT015_Hwin30_tag07_fake001_CorrectOne/150702_224435/0000";
  fbkg = "ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT015_Hwin30_tag07_fake001/150703_215615/0000";
  sig_l = PartonMatch(dir,fsig,25,dRmax,MjCone,display,postfix);
  bkg_l = PartonMatch(dir,fbkg,6,dRmax,MjCone,display,postfix);
