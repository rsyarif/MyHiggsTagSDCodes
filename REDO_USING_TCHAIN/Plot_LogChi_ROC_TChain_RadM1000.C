...
void makeHistos_3bkg_optimization_Hwin_300470(){
  ...
  info = "signal: Rad->HH M1000";
  //1st set
  postfix.push_back("RadM1000_KtHW20tag07fake02_pt300470"); labels.push_back("#DeltaM_{H}=20, tag70%, fake 20%");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT015_Hwin20_tag07_fake02/150703_002256/0000/*.root");
  ...
  //2nd set
  postfix.push_back("RadM1000_KtHW30tag07fake02_pt300470"); labels.push_back("#DeltaM_{H}=30, tag 70% fake 20%");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT015_Hwin30_tag07_fake02/150703_001959/0000/*.root");
...
void makeHistos_3bkg_optimization_fake_300470(){
  ...
  info = "signal: Rad->HH M1000";
  //1st set
  postfix.push_back("RadM1000_KtHW30tag07fake001_pt300470"); labels.push_back("#DeltaM_{H}=30, tag70%, fake 1%");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT015_Hwin30_tag07_fake001/150703_001830/0000/*.root");
...
void makeHistos_3bkg_optimization_MjCone10_300470(){
  ...
  info = "signal: Rad->HH M1000";
  //1st set
  postfix.push_back("RadM1000_KtR010HW30tag07fake02_pt300470"); labels.push_back("Kt R=0.10");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT010_Hwin30_tag07_fake02/150703_002442/0000/*.root");
  ...
  //2nd set
  postfix.push_back("RadM1000_KtR015HW30tag07fake02_pt300470"); labels.push_back("Kt R=0.15");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT015_Hwin30_tag07_fake02/150703_001959/0000/*.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT015_Hwin30_tag07_fake02/150703_215645/0000/*.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/QCD_Pt-300to470_Tune4C_13TeV_pythia8/QCDpt300_kT015_Hwin30_tag07_fake02/150706_204303/0000/*.root"); 
...
void makeHistos_3bkg_optimization_MjCone20_300470(){
  ...
  info = "signal: Rad->HH M1000";
  //1st set
  postfix.push_back("RadM1000_KtR020HW30tag07fake02_pt300470"); labels.push_back("Kt R=0.20");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT020_Hwin30_tag07_fake02/150703_002549/0000/*.root");
...
void makeHistos_3bkg_optimization_tag_300470(){
  ...
  info = "signal: Rad->HH M1000";
  //1st set
  postfix.push_back("RadM1000_KtHW30tag06fake02_pt300470"); labels.push_back("#DeltaM_{H}=30, tag 60%, fake 20%");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT015_Hwin30_tag06_fake02/150703_002708/0000/*.root");
...
void makeHistos_3bkg_optimization_Hwin_470600(){
  ...
  info = "signal: Rad->HH M1000";
  //1st set
  postfix.push_back("RadM1000_KtHW20tag07fake02_pt470600"); labels.push_back("#DeltaM_{H}=20, tag70%, fake 20%");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT015_Hwin20_tag07_fake02/150703_002256/0000/*.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT015_Hwin20_tag07_fake02/150703_215830/0000/*.root");
  ...
  //2nd set
  postfix.push_back("RadM1000_KtHW30tag07fake02_pt470600"); labels.push_back("#DeltaM_{H}=30, tag 70% fake 20%");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT015_Hwin30_tag07_fake02/150703_001959/0000/*.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT015_Hwin30_tag07_fake02/150703_215645/0000/*.root");
...
void makeHistos_3bkg_optimization_fake_470600(){
  ...
  info = "signal: Rad->HH M1000";
  //1st set
  postfix.push_back("RadM1000_KtHW30tag07fake001_pt470600"); labels.push_back("#DeltaM_{H}=30, tag70%, fake 1%");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT015_Hwin30_tag07_fake001/150703_001830/0000/*.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT015_Hwin30_tag07_fake001/150703_215615/0000/*.root");
...
void makeHistos_3bkg_optimization_MjCone10_470600(){
  ...
  info = "signal: Rad->HH M1000";
  //1st set
  postfix.push_back("RadM1000_KtR010HW30tag07fake02_pt470600"); labels.push_back("Kt R=0.10");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT010_Hwin30_tag07_fake02/150703_002442/0000/*.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT010_Hwin30_tag07_fake02/150703_215908/0000/*.root");
  ...
  //2nd set
  postfix.push_back("RadM1000_KtR015HW30tag07fake02_pt470600"); labels.push_back("Kt R=0.15");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT015_Hwin30_tag07_fake02/150703_001959/0000/*.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT015_Hwin30_tag07_fake02/150703_215645/0000/*.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/QCD_Pt-470to600_Tune4C_13TeV_pythia8/QCDpt470_kT015_Hwin30_tag07_fake02/150706_204344/0000/*.root"); 
...
void makeHistos_3bkg_optimization_MjCone20_470600(){
  ...
  info = "signal: Rad->HH M1000";
  //1st set
  postfix.push_back("RadM1000_KtR020HW30tag07fake02_pt470600"); labels.push_back("Kt R=0.20");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT020_Hwin30_tag07_fake02/150703_002549/0000/*.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT020_Hwin30_tag07_fake02/150703_215948/0000/*.root");
...
void makeHistos_3bkg_optimization_tag_470600(){
  ...
  info = "signal: Rad->HH M1000";
  //1st set
  postfix.push_back("RadM1000_KtHW30tag06fake02_pt470600"); labels.push_back("#DeltaM_{H}=30, tag 60%, fake 20%");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT015_Hwin30_tag06_fake02/150703_002708/0000/*.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT015_Hwin30_tag06_fake02/150703_220034/0000/*.root");
...
void makeHistos_3bkg_compareSubstructure_300470(){
  ...
  postfix = "RadM1000_KtHW30tag07fake02_3bkg_pt300470";labels.push_back("#DeltaM_{H}=30, tag 70% fake 20%");
...
void makeHistos_3bkg_compareSubstructure_opt_300470(){
  ...
  fs->Add("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M1000_13TeV_PHYS14_25_V1/Rad_M1000_kT020_Hwin30_tag07_fake02/150703_002549/0000/*.root");
  ...
  postfix = "RadM1000_Kt020HW30tag07fake02_3bkg_pt300470";labels.push_back("#DeltaM_{H}=30 tag=70% fake=20% r=0.2");
...
void makeHistos_3bkg_compareSubstructure_opt_470600(){
  ...
  postfix = "RadM1000_Kt020HW30tag07fake02_3bkg_pt470600";labels.push_back("#DeltaM_{H}=30 tag=70% fake=20% r=0.2");
