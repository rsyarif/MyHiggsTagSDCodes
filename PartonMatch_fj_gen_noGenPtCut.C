...
void PartonMatch_loose(){
  ...
  canvas->SaveAs((dir+"/"+fsig+"_loose_match_fj_genH_noGenPtCut.eps").c_str());
...
void PartonMatch_med(){
  ...
  canvas->SaveAs((dir+"/"+fsig+"_med_match_fj_genH_noGenPtCut.eps").c_str());
...
void PartonMatch_tight(){
  ...
  canvas->SaveAs((dir+"/"+fsig+"_tight_match_fj_genH_noGenPtCut.eps").c_str());
