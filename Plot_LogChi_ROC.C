...
void ROC(string fname,string fdenom,string fsave, const int xbin, double xmin, double xmax){
...
void ROC_combined(string fname1, string fname2){
  ...
  c->SaveAs("rootfiles/TEMP_ROC_Combined.eps");
}
...
void makeHistos(){
  ...
  ROC(fsave1,fsave2,postfix1,40,-26,-6);
  ...
  ROC(fsave1,fsave2,postfix2,40,-26,-6);

}

void makeROC_combined(){
  ROC_combined("TEMP_fhistos_ROC_KtHW20fake001.root","TEMP_fhistos_ROC_AkHW30fake02.root");
}
