...
void ROC_combined3_3bkg(string fname1, string fname2, string fname3, string fsave,vector<string> labels, vector<TString> infos){
  ...
  c->SaveAs(("plots/ROC_Combined3_"+fsave+".eps").c_str());
}
...
void makeHistos_3bkg_optimization(vector<TString> chains, vector<string> postfix, vector<string> labels, string minPt, string maxPt, TString info_){
  ...
  ROC_combined_3bkg(("TEMP_fhistos_ROC_logchi_"+postfix[0]+".root").c_str(),("TEMP_fhistos_ROC_logchi_"+postfix[1]+".root").c_str(),("logchi_"+postfix[0]+"_"+postfix[1]).c_str(),labels, infos);
}

void makeHistos_3bkg_optimization_Hwin(){
  vector<TString> chains;
  ...
  //1st set
  postfix.push_back("KtHW20tag07fake02_3bkg_pt300470"); labels.push_back("#DeltaM_{H}=20, tag70%, fake 20%");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/Rad_HHto4b_M800_13TeV/Rad_M800_kT015_Hwin20_tag07_fake02/150702_225707/Rad_M800_kT015_Hwin20_tag07_fake02.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola/Zpr_M1000_kT015_Hwin20_tag07_fake02/150703_215830/Zpr_M1000_kT015_Hwin20_tag07_fake02.root");
  chains.push_back("/eos/uscms/store/user/rsyarif/SDstudies/QCD_Pt-300to470_Tune4C_13TeV_pythia8/QCDpt300_kT015_Hwin20_tag07_fake02/150703_022056/QCDpt300_kT015_Hwin20_tag07_fake02_crab_6jobs.root");
  //2nd set
  postfix.push_back("KtHW30tag07fake02_3bkg_pt300470"); labels.push_back("#DeltaM_{H}=30, tag 70% fake 20%");
  chains.push_back("rootfiles/Rad_M800_kT015_Hwin30_tag07_fake02_25ns.root");
  chains.push_back("rootfiles/ZPrimeToTTJets_M1000GeV_W10GeV_Tune4C_13TeV-madgraph-tauola_R08_r015_KtMj_HiggsWin30_tagr07_fake02_BtagALLMj_MjIVF015_mc_subjets.root");
  chains.push_back("rootfiles/QCD_Pt-300to470_Tune4C_13TeV_pythia8_R08_r015_KtMj_HiggsWin30_tagr07_fake02_BtagALLMj_MjIVF015_MORE_mc_subjets.root");
...
void makeHistos_3bkg_compareSubstructure(){
  ...
  postfix = "KtHW30tag07fake02_3bkg_pt300470";labels.push_back("#DeltaM_{H}=30, tag 70% fake 20%");
  ...
  ROC_combined3_3bkg(("TEMP_fhistos_ROC_logchi_"+postfix+".root").c_str(),("TEMP_fhistos_ROC_qvol_"+postfix+".root").c_str(),("TEMP_fhistos_ROC_tau21_"+postfix+".root").c_str(),("logchi_"+postfix+"_qvol_tau21").c_str(),labels_, info);
}
