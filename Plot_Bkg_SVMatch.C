{
  ...
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_pt_abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4.eps").c_str());

  t->Draw("Mj_pt","abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4&&Mj_isBtag==1");

  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_pt_abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4&&Mj_isBtag==1.eps").c_str());

  t->Draw("Mj_pt","Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999");

  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_pt_Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999.eps").c_str());

  t->Draw("Mj_pt","Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4");

  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_pt_Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4.eps").c_str());
  ...
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_pt_Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4&&Mj_isBtag==1.eps").c_str());
  //
  ...
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_gen_matched_pdgID_abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4.eps").c_str());
  ...
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_gen_matched_pdgID_abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4&&Mj_isBtag==1.eps").c_str());

  t->Draw("Mj_gen_matched_pdgID","Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999");

  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_gen_matched_pdgID_Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999.eps").c_str());
  ...
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_gen_matched_pdgID_Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4.eps").c_str());
  ...
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_gen_matched_pdgID_Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4&&Mj_isBtag==1.eps").c_str());
  //
  ...
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_gen_matched_eta_abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4.eps").c_str());
  ...
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_gen_matched_eta_abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4&&Mj_isBtag==1.eps").c_str());

  t->Draw("Mj_gen_matched_eta","Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999");

  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_gen_matched_eta_Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999.eps").c_str());
  ...
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_gen_matched_eta_Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4.eps").c_str());
  ...
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_gen_matched_eta_Mj_dR_gen<0.05&&abs(Mj_gen_matched_pdgID)<99999&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4&&Mj_isBtag==1.eps").c_str());
  //
  ...
  h_1->Draw("LEGO2");
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_pt:Mj_gen_matched_pdgID_abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4.eps").c_str());

  h_2->Draw("LEGO2");
  c1->SaveAs(("rootfiles/"+fname+postfix+"_Mj_pt:Mj_gen_matched_pdgID_Mj_isBtag==1&&abs(Mj_gen_matched_pdgID)!=5&&abs(Mj_gen_matched_pdgID)!=4.eps").c_str());
